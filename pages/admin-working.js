...
import { DeleteIcon, ViewIcon, EmailIcon, LockIcon } from "@chakra-ui/icons";
...
export default function AdminWorking() {
  ...
  const loadMessages = () => {
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to load messages from storage",
        status: "error",
        duration: 3000,
        isClosable: true,
      });
  ...
  if (isLoading) {
    return (
      <Box minH="100vh" bg="gray.50" display="flex" alignItems="center" justifyContent="center">
        <VStack spacing={4}>
          <Text fontSize="xl" fontWeight="medium">Loading admin dashboard...</Text>
          <Text color="gray.500">Please wait while we load your messages</Text>
        </VStack>
      </Box>
    );
  }
        ...
        <Container maxW="7xl" py={4}>
          <HStack justify="space-between" align="center">
            <VStack align="start" spacing={1}>
              <Heading size="lg" color="brand.600">Admin Dashboard</Heading>
