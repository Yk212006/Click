...
export default function LaminatedWoodenFlooring() {
  return (
    <Box>
      {/* Breadcrumb */}
      <Box bg="gray.50" py={4} borderBottom="1px solid" borderColor="gray.200">
        <Container maxW="7xl">
          <Breadcrumbs productName="Laminated Wooden Flooring" />
        </Container>
      </Box>
        ...
        <Container maxW="7xl">
          <Grid templateColumns={{ base: "1fr", lg: "1.2fr 0.8fr" }} gap={{ base: 8, md: 12 }} alignItems="start">
            ...
            <Box>
              ...
              <ProductGallery productPath="laminated-flooring" />
            </Box>
            ...
            <VStack spacing={6} align="start">
              ...
              <Text
                ...
                lineHeight="1.6"
              >
                Laminated wooden flooring offers the perfect balance of affordability, durability, and aesthetic appeal. Featuring a multi-layer construction with a high-resolution photographic layer that mimics natural wood, topped with a tough wear layer, this flooring solution is ideal for high-traffic areas in both residential and commercial spaces.
              </Text>
              ...
              <VStack spacing={3} w="full" pt={4}>
                <Button
                  ...
                  transition="all 0.2s"
                  as="a"
                  href="mailto:info@clickinteriorsolutions.com?subject=Quote Request - Laminated Wooden Flooring"
                >
                  Request Quote
                </Button>
