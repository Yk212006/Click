  ...
  return (
    <Box>
      ...
      <Box bg="gray.50" py={4} borderBottom="1px solid" borderColor="gray.200">
        <Container maxW="7xl">
          <Breadcrumbs productName="LVT Flooring" />
        </Container>
      </Box>
        ...
        <Container maxW="7xl">
          <Grid templateColumns={{ base: "1fr", lg: "1.2fr 0.8fr" }} gap={{ base: 8, md: 12 }} alignItems="start">
            ...
            <Box>
              ...
              <ProductGallery productPath="lvt-flooring" />
            </Box>
            ...
            <VStack spacing={6} align="start">
              ...
              <Text
                ...
                lineHeight="1.6"
              >
                Luxury Vinyl Tile (LVT) flooring combines the realistic appearance of natural materials with the practical benefits of vinyl. Featuring high-definition printing technology and advanced embossing techniques, LVT provides authentic wood and stone looks with superior durability and performance characteristics.
              </Text>
              ...
              <Box>
                ...
                <Grid templateColumns={{ base: "1fr", md: "1fr 1fr" }} gap={3}>
                  {[
                    ...
                    "Textured surface for authenticity",
              ...
              <VStack spacing={3} w="full" pt={4}>
                <Button
                  ...
                  transition="all 0.2s"
                  as="a"
                  href="mailto:info@clickinteriorsolutions.com?subject=Quote Request - LVT Flooring"
                >
                  Request Quote
                </Button>
