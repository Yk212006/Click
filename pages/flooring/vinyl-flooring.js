  ...
  return (
    <Box>
      ...
      <Box bg="gray.50" py={4} borderBottom="1px solid" borderColor="gray.200">
        <Container maxW="7xl">
          <Breadcrumbs productName="Vinyl Flooring" />
        </Container>
      </Box>
        ...
        <Container maxW="7xl">
          <Grid templateColumns={{ base: "1fr", lg: "1.2fr 0.8fr" }} gap={{ base: 8, md: 12 }} alignItems="start">
            ...
            <Box>
              ...
              <ProductGallery productPath="vinyl-flooring" />
            </Box>
            ...
            <VStack spacing={6} align="start">
              ...
              <Text
                ...
                lineHeight="1.6"
              >
                Vinyl flooring offers versatile, durable, and affordable flooring solutions suitable for virtually any application. Available in rolls, tiles, planks, and self-leveling options, modern vinyl flooring provides realistic wood and stone appearances with exceptional performance characteristics.
              </Text>
              ...
              <VStack spacing={3} w="full" pt={4}>
                <Button
                  ...
                  transition="all 0.2s"
                  as="a"
                  href="mailto:info@clickinteriorsolutions.com?subject=Quote Request - Vinyl Flooring"
                >
                  Request Quote
                </Button>
