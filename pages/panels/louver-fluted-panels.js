...
export default function LouverFlutedPanels() {
  return (
    <Box>
      {/* Breadcrumb */}
      <Box bg="gray.50" py={4} borderBottom="1px solid" borderColor="gray.200">
        <Container maxW="7xl">
          <Breadcrumbs productName="Louver and Fluted Panels" />
        </Container>
      </Box>
        ...
        <Container maxW="7xl">
          <Grid templateColumns={{ base: "1fr", lg: "1.2fr 0.8fr" }} gap={{ base: 8, md: 12 }} alignItems="start">
            ...
            <Box>
              ...
              <ProductGallery productPath="louver-fluted-panels" />
            </Box>
            ...
            <VStack spacing={6} align="start">
              ...
              <Text
                ...
                lineHeight="1.6"
              >
                Louver and fluted panels offer sophisticated architectural solutions for modern interior design. Featuring linear patterns and dimensional surfaces, these panels create visual interest while providing functional benefits such as partial privacy, light diffusion, and airflow management.
              </Text>
              ...
              <VStack spacing={3} w="full" pt={4}>
                <Button
                  ...
                  _hover={{ bg: "#166B32" }}
                  transition="all 0.2s"
                                    href="mailto:info@clickinteriorsolutions.com?subject=Quote Request - Louver and Fluted Panels"
                >
                  Request Quote
                </Button>
