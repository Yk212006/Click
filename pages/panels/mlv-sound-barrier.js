...
export default function MLVSoundBarrier() {
  return (
    <Box>
      {/* Breadcrumb */}
      <Box bg="gray.50" py={4} borderBottom="1px solid" borderColor="gray.200">
        <Container maxW="7xl">
          <Breadcrumbs productName="MLV Sound Barrier" />
        </Container>
      </Box>
        ...
        <Container maxW="7xl">
          <Grid templateColumns={{ base: "1fr", lg: "1.2fr 0.8fr" }} gap={{ base: 8, md: 12 }} alignItems="start">
            ...
            <Box>
              ...
              <ProductGallery productPath="mlv-sound-barrier" />
            </Box>
            ...
            <VStack spacing={6} align="start">
              ...
              <Text
                ...
                lineHeight="1.6"
              >
                Mass Loaded Vinyl (MLV) sound barriers provide superior sound insulation by adding mass and density to walls, ceilings, and floors. This versatile material effectively blocks sound transmission between spaces, making it ideal for creating quiet environments.
              </Text>
              ...
              <VStack spacing={3} w="full" pt={4}>
                <Button
                  ...
                  _hover={{ bg: "#166B32" }}
                  transition="all 0.2s"
                                    href="mailto:info@clickinteriorsolutions.com?subject=Quote Request - MLV Sound Barrier"
                >
                  Request Quote
                </Button>
