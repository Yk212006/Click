...
export default function HPLCladding() {
  return (
    <Box>
      {/* Breadcrumb */}
      <Box bg="gray.50" py={4} borderBottom="1px solid" borderColor="gray.200">
        <Container maxW="7xl">
          <Breadcrumbs productName="HPL Cladding" />
        </Container>
      </Box>
        ...
        <Container maxW="7xl">
          <Grid templateColumns={{ base: "1fr", lg: "1.2fr 0.8fr" }} gap={{ base: 8, md: 12 }} alignItems="start">
            ...
            <Box>
              ...
              <ProductGallery productPath="hpl-cladding" />
            </Box>
            ...
            <VStack spacing={6} align="start">
              ...
              <Text
                ...
                lineHeight="1.6"
              >
                High-Pressure Laminate (HPL) cladding provides durable, versatile surfacing solutions for both interior and exterior applications. Engineered under high pressure and temperature, HPL panels offer exceptional resistance to wear, impact, weather, and UV radiation.
              </Text>
              ...
              <VStack spacing={3} w="full" pt={4}>
                <Button
                  ...
                  _hover={{ bg: "#166B32" }}
                  transition="all 0.2s"
                                    href="mailto:info@clickinteriorsolutions.com?subject=Quote Request - HPL Cladding"
                >
                  Request Quote
                </Button>
