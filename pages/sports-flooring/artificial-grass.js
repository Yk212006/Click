  ...
  return (
    <Breadcrumb spacing="8px" separator={<ChevronRightIcon color="gray.500" />}>
      ...
      <BreadcrumbItem isCurrentPage>
        <BreadcrumbLink>Artificial Grass</BreadcrumbLink>
      </BreadcrumbItem>
    </Breadcrumb>
  );
};
        ...
        <Container maxW="7xl">
          <Grid templateColumns={{ base: "1fr", md: "1fr 1fr" }} gap={12} alignItems="start">
            ...
            <Box>
              ...
              <ProductGallery productPath="/sports-flooring/artificial-grass" />
            </Box>
            ...
            <Box>
              ...
              <Text color="gray.600" fontSize="18px" mb={6} lineHeight="1.8">
                High-quality artificial grass solutions for sports fields, playgrounds, and landscapes. UV-resistant, durable, and maintenance-free alternative to natural grass.
              </Text>
              ...
              <Box mb={8}>
                ...
                <Grid templateColumns="repeat(2, 1fr)" gap={4}>
                  {["UV Resistant", "All-Weather Performance", "Low Maintenance", "Natural Look & Feel", "Drainage System"].map((feature, index) => (
