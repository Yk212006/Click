  ...
  return (
    <Breadcrumb spacing="8px" separator={<ChevronRightIcon color="gray.500" />}>
      ...
      <BreadcrumbItem isCurrentPage>
        <BreadcrumbLink>Gym Flooring</BreadcrumbLink>
      </BreadcrumbItem>
    </Breadcrumb>
  );
};
        ...
        <Container maxW="7xl">
          <Grid templateColumns={{ base: "1fr", md: "1fr 1fr" }} gap={12} alignItems="start">
            ...
            <Box>
              ...
              <ProductGallery productPath="/sports-flooring/gym-flooring" />
            </Box>
            ...
            <Box>
              ...
              <Text color="gray.600" fontSize="18px" mb={6} lineHeight="1.8">
                Professional gym flooring solutions designed for heavy-duty performance. Ideal for fitness centers, weight rooms, and commercial gym environments.
              </Text>
              ...
              <Box mb={8}>
                ...
                <Grid templateColumns="repeat(2, 1fr)" gap={4}>
                  {["Shock Absorption", "Noise Reduction", "Heavy-Duty Durability", "Easy to Clean", "Interlocking System"].map((feature, index) => (
