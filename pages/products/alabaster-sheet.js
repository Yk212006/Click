...
export default function AlabasterSheet() {
  const router = useRouter();

  return (
    <Box>
      {/* Breadcrumb */}
      <Breadcrumbs productName="Alabaster Sheet" />
      ...
      <Box py={{ base: 12, md: 20 }} bg="white">
        <Container maxW="7xl">
          <Grid templateColumns={{ base: "1fr", md: "1fr 1fr" }} gap={12} alignItems="start">
            {/* Image Gallery */}
            <Box>
              <ProductGallery productPath="alabaster-sheet" />
            </Box>
            ...
            <Box>
              ...
              <Text color="gray.600" fontSize="18px" mb={6} lineHeight="1.8">
                Premium alabaster sheets offering elegant translucency and sophisticated beauty. 
                Perfect for decorative panels, lighting applications, and luxury interior design projects 
                that require a touch of natural elegance.
              </Text>
              ...
              <Box mb={8}>
                ...
                <VStack align="start" spacing={2} color="gray.700">
                  <Text>• Interior wall panels</Text>
                  <Text>• Backlit features</Text>
                  <Text>• Decorative partitions</Text>
                  <Text>• Lighting fixtures</Text>
                  <Text>• Luxury furniture</Text>
                  <Text>• Retail displays</Text>
                </VStack>
              </Box>
