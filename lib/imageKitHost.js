...
export const IMAGEKIT_CONFIG = {
  urlEndpoint: 'https://ik.imagekit.io/demo', // Using demo for now, replace with your ImageKit ID
  publicKey: 'public_+D9N8ZfS5zS6vL8ZfS5zS6vL8ZfS5zS6vL8', // Demo public key
...
export const getProductImageUrl = (imagePath, customOptions = {}) => {
  // Fallback to working placeholders if ImageKit not configured
  const workingPlaceholders = {
    'flooring/engineered-wooden-flooring': 'https://ik.imagekit.io/demo/tr:w-600,h-450,c-fill,q-85,f-auto/placeholder_engineered_wood.jpg',
    'wallpaper': 'https://ik.imagekit.io/demo/tr:w-600,h-450,c-fill,q-85,f-auto/placeholder_wallpaper.jpg',
    'default': 'https://ik.imagekit.io/demo/tr:w-600,h-450,c-fill,q-85,f-auto/default_product.jpg'
  };
