...
export const getGalleryImages = (productPath) => {
  ...
  console.log('🔍 Getting gallery images for:', productPath);
  ...
  const galleryMap = {
    ...
    'panels': [
      `${baseUrl}/panels/lp1.jpg`,
      `${baseUrl}/panels/lp2.jpg`,
      `${baseUrl}/panels/lp3.jpg`,
      `${baseUrl}/panels/lp4.jpg`,
      `${baseUrl}/panels/lp5.avif`
    ],
    'louver-panels': [
      `${baseUrl}/panels/lp1.jpg`,
      `${baseUrl}/panels/lp2.jpg`,
    ...
    'pvc-panels': [
      `${baseUrl}/panels/pvc1.jpg`,
      `${baseUrl}/panels/pvc2.jpg`,
      `${baseUrl}/panels/pvc3.jpg`,
      `${baseUrl}/panels/pvc4.jpg`,
      `${baseUrl}/panels/pvc5.jpg`
    ],
    'louver-fluted-panels': [
      `${baseUrl}/panels/fl1.jpg`,
      `${baseUrl}/panels/fl2.jpg`,
      `${baseUrl}/panels/fl3.jpg`,
      `${baseUrl}/panels/fl4.jpg`,
      `${baseUrl}/panels/fl5.jpg`
    ],
    'mlv-sound-barrier': [
      `${baseUrl}/panels/mlv1.avif`,
      `${baseUrl}/panels/mlv2.jpg`,
      `${baseUrl}/panels/mlv3.jpg`,
      `${baseUrl}/panels/mlv4.jpg`,
      `${baseUrl}/panels/mlv5.jpg`
    ],
    'hpl-cladding': [
      `${baseUrl}/panels/hpl1.jpg`,
      `${baseUrl}/panels/hpl2.jpg`,
      `${baseUrl}/panels/hpl3.jpg`,
      `${baseUrl}/panels/hpl4.jpg`,
      `${baseUrl}/panels/hpl5.jpg`
    ],
    'acoustic-panels': [
      `${baseUrl}/panels/ap1.jpg`,
      `${baseUrl}/panels/ap2.jpg`,
      `${baseUrl}/panels/ap3.jpg`,
      `${baseUrl}/panels/ap4.jpg`,
      `${baseUrl}/panels/ap5.jpg`
    ],
    'charcoal-panels': [
      `${baseUrl}/panels/cp1.jpg`,
      `${baseUrl}/panels/cp2.jpg`,
      `${baseUrl}/panels/cp3.jpg`,
      `${baseUrl}/panels/cp4.jpg`,
      `${baseUrl}/panels/cp5.jpg`
    ]
  };
